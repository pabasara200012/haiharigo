      ...
      <div className="container mx-auto px-3 py-4 sm:px-4 lg:px-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-3 text-sm font-semibold text-slate-900">
            <img src="/haiharigo/images/logo.svg" alt="HariහරිGo logo" className="h-12 w-auto" />
          </Link>
          ...
          <div className="flex items-center gap-3">
            <Link href={variant === 'home' ? '#contact' : '/contact'} className="inline-flex items-center justify-center rounded-full bg-[#0A2F6B] px-5 py-3 text-sm font-semibold text-white shadow-soft transition hover:bg-[#0c3478]">
              දැන් ඇනවුම් කරන්න
            </Link>
          </div>
        </div>
